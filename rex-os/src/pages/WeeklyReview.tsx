...
import { BarChart2, TrendingUp, Music, Play, CheckCircle2, Clock, Zap, Target, ArrowRight } from "lucide-react";
import { useAppContext } from "../context/AppContext";

export default function WeeklyReview() {
  const { weeklyReview, activityLog } = useAppContext();
          ...
          <Card className="border-border/50 bg-gradient-to-br from-card to-secondary/20">
            ...
            <CardContent>
              ...
              <div className="flex justify-end mt-3">
                <button className="bg-primary text-primary-foreground px-6 py-2 rounded-lg font-bold text-sm shadow hover:bg-primary/90 transition-colors">
                  Save Reflection
                </button>
              </div>
            </CardContent>
            ...
            <CardContent>
              <ul className="space-y-2">
                <li className="flex items-start gap-2 text-sm font-medium">
                  ...
                  Increase deep work blocks to 4 per day.
                </li>
                <li className="flex items-start gap-2 text-sm font-medium">
                  <ArrowRight className="w-4 h-4 text-orange-500 shrink-0 mt-0.5" />
                  Batch create 5 beats on Monday.
                </li>
                <li className="flex items-start gap-2 text-sm font-medium">
                  <ArrowRight className="w-4 h-4 text-orange-500 shrink-0 mt-0.5" />
                  Schedule all YouTube shorts for the week by Wednesday.
                </li>
              </ul>
            </CardContent>
          </Card>
